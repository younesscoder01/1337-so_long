...
/*   Updated: 2024/05/20 17:52:41 by ysahraou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int key_p(int keycode, void *param)
{
	...
	else if ((65361 == keycode || 97 == keycode) && (param_1->map[param_1->p_y][param_1->p_x-1] != '1' && ((param_1->map[param_1->p_y][param_1->p_x-1] != 'E') || param_1->coin_c == 0)))
	{
	...
	else if ((65362 == keycode || 119 == keycode) && (param_1->map[param_1->p_y-1][param_1->p_x] != '1' && ((param_1->map[param_1->p_y-1][param_1->p_x] != 'E') || param_1->coin_c == 0)))
	{
	...
	else if ((65363 == keycode || 100 == keycode) && (param_1->map[param_1->p_y][param_1->p_x+1] != '1' && ((param_1->map[param_1->p_y][param_1->p_x+1] != 'E') || param_1->coin_c == 0)))
	{
		mlx_put_image_to_window(param_1->mlx_ptr, param_1->mlx_win, param_1->player, (param_1->p_x+1) * 34, param_1->p_y * 34);
		mlx_put_image_to_window(param_1->mlx_ptr, param_1->mlx_win, param_1->floor, param_1->p_x * 34, param_1->p_y * 34);
		if (param_1->map[param_1->p_y][param_1->p_x+1] == 'C')
	...
	else if ((65364 == keycode || 115 == keycode) && (param_1->map[param_1->p_y+1][param_1->p_x] != '1' && ((param_1->map[param_1->p_y+1][param_1->p_x] != 'E') || param_1->coin_c == 0)))
	{
		mlx_put_image_to_window(param_1->mlx_ptr, param_1->mlx_win, param_1->player, param_1->p_x * 34, (param_1->p_y+1) * 34);
		mlx_put_image_to_window(param_1->mlx_ptr, param_1->mlx_win, param_1->floor, param_1->p_x * 34, param_1->p_y * 34);
		if (param_1->map[param_1->p_y+1][param_1->p_x] == 'C')
...
int	main(int argc, char *argv[])
{
	...
	if (!cheack_wall(map, map_height, map_widht))
		return 13;
	// flood_fill(map, param.p_x, param.p_y, map_height, map_widht);
