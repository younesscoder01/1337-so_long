...
/*   Updated: 2024/05/23 21:16:38 by ysahraou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void allocation(t_param	*param)
{
	...
	param->mlx_win = mlx_new_window(param->mlx_ptr, param->map_widht * 34, param->map_height * 34, "so_long");
	param->wall = mlx_xpm_file_to_image(param->mlx_ptr, "textures/wall_v2.xpm", &param->img_widht, &param->img_height);
	param->bat = mlx_xpm_file_to_image(param->mlx_ptr, "textures/bat_f1.xpm", &param->img_widht, &param->img_height);
	...
	param->player_left = mlx_xpm_file_to_image(param->mlx_ptr, "textures/kinght_m.xpm", &param->img_widht, &param->img_height);
